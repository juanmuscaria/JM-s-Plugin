package io.github.juanmuscaria.mintasm.bukkit.utils;

import io.github.juanmuscaria.mintasm.bukkit.PluginConfig;
...
public class Logger {
    ...
    public static void cLog(String text) {
        CCS.sendMessage(ChatColor.AQUA + "[" + ChatColor.GREEN + "MintASMBukkit" + ChatColor.AQUA + "]" + ChatColor.WHITE + text);
    }

    //debug
    public static void Debug(String text) {
        if (PluginConfig.pluginConfig.debug)
            CCS.sendMessage(ChatColor.DARK_AQUA + "[" + ChatColor.GOLD + "MintDebug" + ChatColor.DARK_AQUA + "]" + ChatColor.WHITE + text);
    }
